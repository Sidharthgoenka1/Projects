...
public class AvailableDistForInventory {
	...
	public String toString() {
		return "AvailableDistForInventory [invId=" + invId + ", invName=" + invName + ", invDesc=" + invDesc
				+ ", distId=" + distId + ", distName=" + distName + ", distAddress=" + distAddress + ", distContact="
				+ distContact + ", wAddress=" + wAddress + ", wName=" + wName + ", wContact=" + wContact + ", wId="
				+ wId + ", email=" + email + ", quantity=" + quantity + "]";
	}
